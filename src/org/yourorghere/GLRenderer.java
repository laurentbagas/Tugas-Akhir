...
public class GLRenderer implements GLEventListener {
    ...
    vector depanBelakang = new vector(0f, 0f, -1f);//deklarasiawal vektor untuk maju & mundur 
    ...
    float silinderAngel = 90f;

    boolean ori = true, silinder = false, silinder2 = false, kamera = false;
...
digunakan untuk menentukan arah.
 gunakan -1 untuk arah berlawanan dengan vektor awal
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glPushMatrix();
        gl.glTranslatef(4.3f, 0.9f, -15f);
        gl.glRotatef(silinderAngle, 0f, 10, 0);
        Objek.O(gl);
        gl.glPopMatrix();
        gl.glPushMatrix();
        gl.glTranslatef(-4f, 0.9f, -15f);;
        gl.glRotatef(silinderAngel, 0f, 10, 0);
        Objek.K(gl);
        gl.glPopMatrix();
