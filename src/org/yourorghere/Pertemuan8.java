...
public class Pertemuan8 extends JFrame {
 ...
 pack();
    ...
    private GLCapabilities createGLCapabilites() {
        ...
        // try to enable 2x anti aliasing - should be supported onmost hardware
    ...
    public static void main(String args[]) {
        // Run this in the AWT event thread to prevent deadlocks andrace conditions
...
Logger.getLogger(getClass().getName()).log(Level.INFO, "can notenable system look and feel", ex);
 ...
 Pertemuan8 frame = new Pertemuan8();
